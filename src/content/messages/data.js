...
`,
        ...
        },
        {
            ...
            date: '08 Feb 1995',
            body: `Купил себе Cyrix 5x86-100. В Quake дает почти столько же кадров, сколько первый Пень!
...
`,
        ...
        },
        {
            ...
            date: '08 Feb 1995',
            body: `Не смеши мои тапочки. Твой Cyrix греется как утюг, а FPU (сопроцессор) у него дохлый.
...
`,
        ...
        },
        {
            ...
            date: '08 Feb 1995',
            body: `GoldED стал попсой. Куча ненужных фич, цвета эти попугайские, конфиг на 10 страниц.
...
`,
        ...
        },
        {
            ...
            date: '07 Feb 1995',
            body: `Продам мамку с процем 386DX-40 и 4Mb RAM.
...
`,
        ...
        },
        {
            ...
            date: '07 Feb 1995',
            body: `Поставил этот ваш Линукс (Slackware), запустил редактор vi.
...
`,
        ...
        },
        {
            ...
            date: '07 Feb 1995',
            body: `Добро пожаловать в мир боли :)
