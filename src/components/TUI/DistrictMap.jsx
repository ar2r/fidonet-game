...
const GAME_PATH = [
    ...
    {
        act: 'Акт 3: Сообщество',
        nodes: [
            { id: 'N4', title: 'Эхоконференции (Echo)', desc: 'Чтение правил, общение, получение статуса.', color: '#FF9800' }
        ]
    },
    {
    ...
    },
    {
        act: 'Акт 5: Кризис',
        nodes: [
            { id: 'N7', title: 'Выбор пути', desc: 'Технарь (ремонт линии) или Дипломат (улаживание конфликта).', color: '#E91E63' }
        ]
    },
    {
        act: 'Акт 6: Финал',
        nodes: [
            { id: 'N8', title: 'Встреча с Координатором', desc: 'Финальное собеседование.', color: '#000000' }
        ]
    }
];
